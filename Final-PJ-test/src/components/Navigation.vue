...
<template>
  <nav class="sticky z-30 w-full bg-white border-b border-gray-300">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <a href="http://localhost:5173/main/dashboard" class="flex ml-2 md:mr-24">
            <img
              src="@/assets/logo.png"
              class="h-12 mr-3"
              alt="FlowBite Logo"
          ...
          <form
            action="#"
            method="GET"
            class="hidden lg:block lg:pl-3.5 ml-96"
          ...
          >
            ...
            <div class="relative mt-1 lg:w-96">
              ...
              <input
                ...
                name="email"
                id="topbar-search"
                class="bg-gray-50 border border-gray-300 text-gray-700 text-bs rounded-lg block w-full pl-10 p-2.5"
                placeholder="Search"
              />
            </div>
          </form>
        ...
        <div class="flex items-center" >
          ...
          <button
            ...
            class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-400"
          >
          ...
          <button
            ...
            class="hidden p-2 text-gray-500 rounded-lg sm:flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-400"
          >
            <span class="sr-only">View notifications</span>
          ...
          <!-- dropdown-2-setting -->
          <!-- chưa chỉnh được border -->
          <div class="flex items-center ml-3">
            <div>
              <button
                type="button"
                class="flex text-sm bg-gray-800 rounded-full hover:ring-4 dark:hover:ring-gray-600"
            ...
            <div
              class="z-5000 my-4 text-base list-none border-gray-600 divide-y divide-gray-600 rounded shadow"
              id="dropdown-2"
              v-show="settings"
            >
              <div class="px-4" role="none">
                <p
                  class="text-sm mt-3 text-gray-900 dark:text-black"
                  role="none"
                >
                  Neil Sims
                </p>
                <p
                  class="text-sm font-medium text-gray-900 truncate dark:text-gray-700"
                  role="none"
                >
              ...
              <ul class="py-1" role="none">
                <li>
                  <a
                    href="#"
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-black dark:hover:bg-gray-600 dark:hover:text-white"
                    role="menuitem"
                    >Dashboard</a
                  >
                </li>
