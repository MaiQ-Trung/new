...
import { LOADING_BAR_SHOW_MUTATION, SET_USER_TOKEN_DATA_MUTATION } from "../store/modules/storeconstans";
...
<template>
<form class="min-h-screen bg-gray-100 text-gray-900 flex justify-center" @submit.prevent="onLogin">
                ...
                <div class="w-full flex-1 mt-8">
                    ...
                    <div class="mx-auto max-w-xs">
                      <div class="error-bar" v-if="error">{{ error }}</div>
                        <input
                            class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-lg focus:outline-none focus:border-gray-400 focus:bg-white"
                            type="email" placeholder="Email" v-model.trim="email"/>
                            <div class="error" v-if="error.email">{{ error.email }}</div>
                        <input
                            class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-lg focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
