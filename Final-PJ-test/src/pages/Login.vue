...
<template>
  <form
    class="min-w-96 min-h-screen bg-gradient-to-br from-sky-500 to-purple-500 text-gray-900 flex justify-center"
    @submit.prevent="onLogin"
  >
    <div
      class="sticky md:top-80 lg:top-20 xl:top-32 max-w-screen-lg h-[550px] m-0 sm:m-10 bg-white shadow rounded-3xl flex justify-center flex-1"
    >
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="w-full flex-1 mt-4">
            ...
            <div class="mx-auto max-w-72">
              ...
              <input
                class="w-full px-4 py-1 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-lg focus:outline-none focus:border-gray-400 focus:bg-white"
                type="email"
                placeholder="Email"
                v-model.trim="email"
              />
              <input
                class="w-full px-4 py-1 mb-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-lg focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                type="password"
