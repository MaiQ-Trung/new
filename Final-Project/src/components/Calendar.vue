<template>
  <div class="mt-2 ml-[273px]">
    <!-- <div
      id="default-modal"
      tabindex="-1"
      class="absolute overflow-y-auto bg-slate-400 bg-opacity-10 z-50 w-full md:inset-0 h-full max-h-full"
      v-if="modal"
    > -->
    <div class="absolute z-50 h-full max-w-2xl" v-if="modal">
      <!-- Modal content -->
      <div class="relative h-[560px] w-full bg-white shadow">
        <!-- Modal header -->
        <div
